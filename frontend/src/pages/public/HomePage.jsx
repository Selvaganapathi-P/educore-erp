...
function GCard({ icon: Icon, title, desc, color }) {
  const gradients = {
    ...
    sky:    'from-sky-500/30 to-blue-400/30',
    rose:   'from-rose-500/30 to-pink-500/30',
  };
  const icon_bg = {
  ...
  return (
    <div className="relative group rounded-2xl p-px overflow-hidden"
      ...
      <div className="relative rounded-2xl bg-[#0D1424] p-6 h-full">
        <div className={`w-11 h-11 rounded-xl flex items-center justify-center mb-4 ${icon_bg[color]}`}>
    ...
    <div className="bg-[#0A0F1E] text-white">
      ...
      <section className="relative min-h-[92vh] flex flex-col items-center justify-center overflow-hidden px-4 pt-16 pb-20">
        ...
        <div className="absolute inset-0 pointer-events-none"
          style={{
            backgroundImage: 'radial-gradient(rgba(99,143,255,0.18) 1px, transparent 1px)',
            backgroundSize: '28px 28px',
          }} />

        {/* Animated gradient orbs */}
        <div className="absolute top-[-10%] left-[15%] w-[520px] h-[520px] rounded-full pointer-events-none"
          style={{
            background: 'radial-gradient(circle, rgba(29,78,216,0.35) 0%, transparent 70%)',
            animation: 'orbFloat 9s ease-in-out infinite',
            filter: 'blur(1px)',
          }} />
        <div className="absolute bottom-[-5%] right-[10%] w-[420px] h-[420px] rounded-full pointer-events-none"
          style={{
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="fade-up-3 text-slate-400 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
            EduCore School has nurtured over 1,200 students across Classes 1–12 for 25 years —
            building thinkers, leaders, and compassionate human beings.
          </p>

          {/* CTAs */}
          <div className="fade-up-4 flex flex-wrap gap-3 justify-center">
            <Link to="/contact"
              className="group flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-white transition-all duration-300"
              style={{ background: 'linear-gradient(135deg, #1D4ED8, #2563EB)', boxShadow: '0 0 24px rgba(29,78,216,0.45)' }}>
              Apply for Admission
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link to="/about"
              className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-slate-300 border border-white/10 hover:border-white/25 hover:text-white hover:bg-white/5 transition-all duration-300">
              Explore School
          ...
          <div className="fade-up-4 flex flex-wrap justify-center gap-3 mt-14">
            {[
              ...
              <div key={label}
                className="flex items-center gap-2.5 px-4 py-2 rounded-full border border-white/8 text-sm"
      ...
      <section className="py-24 px-4"
        style={{ background: 'linear-gradient(135deg, #0F1E3D 0%, #0A0F1E 60%, #0F1A2E 100%)' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            ...
            <blockquote className="relative z-10 text-xl md:text-2xl font-light text-slate-200 leading-relaxed pl-4">
              At EduCore School, we believe every child carries a universe of potential within them.
          ...
          <div className="flex items-center gap-4 mt-10 pl-4">
            <div className="w-12 h-12 rounded-full flex items-center justify-center font-black text-lg text-white"
              style={{ background: 'linear-gradient(135deg,#1D4ED8,#7C3AED)' }}>P</div>
            <div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {announcements.map((a, i) => (
                <div key={a._id}
                  className="relative rounded-2xl p-5 group hover:-translate-y-0.5 transition-transform duration-300"
                  style={{
                    background: i % 2 === 0
                      ? 'linear-gradient(135deg, rgba(29,78,216,0.08), rgba(29,78,216,0.03))'
                      : 'linear-gradient(135deg, rgba(245,158,11,0.08), rgba(245,158,11,0.03))',
                    border: `1px solid ${i % 2 === 0 ? 'rgba(29,78,216,0.2)' : 'rgba(245,158,11,0.2)'}`,
                  }}>
      ...
      <section className="py-24 px-4 bg-[#0A0F1E]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-slate-400 text-sm max-w-xl mx-auto mb-12 leading-relaxed">
            Every corner of EduCore School is designed to spark learning, creativity, and growth.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ['🔬', 'Science Labs', '3 fully equipped'],
              ['💻', 'Computer Lab', 'High-speed internet'],
              ['📚', 'Library', '10,000+ books'],
              ['🏆', 'Sports Complex', 'Cricket & courts'],
              ['🎵', 'Music Room', 'All instruments'],
              ['🎨', 'Art Studio', 'Dedicated space'],
              ['🚌', 'Transport', '15 routes'],
              ['🏥', 'Medical Room', 'On-campus nurse'],
            ].map(([emoji, title, sub]) => (
              <div key={title}
                className="rounded-2xl p-4 text-left group hover:scale-[1.02] transition-transform duration-300"
          ...
          <Link to="/facilities"
            className="inline-flex items-center gap-2 mt-10 px-6 py-3 rounded-xl font-semibold text-sm text-white border border-white/10 hover:border-emerald-500/40 hover:bg-emerald-500/5 transition-all duration-300">
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'linear-gradient(135deg, #1D4ED8 0%, #7C3AED 50%, #1D4ED8 100%)' }} />
        <div className="absolute inset-0 pointer-events-none"
          style={{
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-200 mb-8 text-sm leading-relaxed max-w-xl mx-auto">
            Admissions for 2025–26 are open. Take the first step toward a future built on excellence, values, and ambition.
          </p>
          <div className="flex flex-wrap gap-3 justify-center">
            <Link to="/contact"
              className="flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-sm text-blue-900 transition-all duration-300 hover:scale-105"
              style={{ background: 'linear-gradient(135deg,#FCD34D,#F59E0B)', boxShadow: '0 8px 32px rgba(245,158,11,0.4)' }}>
              Apply Now <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/about"
              className="flex items-center gap-2 px-7 py-3.5 rounded-xl font-semibold text-sm text-white border border-white/20 hover:bg-white/10 transition-all duration-300">
              Learn More
            </Link>
          </div>
        </div>
